# My Spaceship Prompt
# the only thing missing are the bold fonts for everything

# Generated by Powerlevel10k configuration wizard on 2023-11-03 at 16:45 CET.
...
() {
  ...
  # IDEA: add variable to toggle "[!?]" and "!2 ?1"
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%B%5F'  # magenta foreground
    ...
    # BE_LIKE_STARSHIP:
    # (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+="${conflicted}⇠"
  ...
  # Custom prefix.
  # Make it bold with %B
  typeset -g POWERLEVEL9K_VCS_PREFIX='%B%fon '
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION=' ' # default: ' '
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_PREFIX='%fvia '
