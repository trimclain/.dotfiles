...
change_color() {
    # polybar
    sed -i -e "s/; Theme: .*/; Theme: $THEME-light/g" $PFILE
    sed -i -e 's/background = #.*/background = #dfdfe0/g' $PFILE
    sed -i -e 's/background-alt = #.*/background-alt = #e7e8eb/g' $PFILE
    sed -i -e 's/foreground = #.*/foreground = #292a30/g' $PFILE
    sed -i -e 's/foreground-alt = #.*/foreground-alt = #414453/g' $PFILE
