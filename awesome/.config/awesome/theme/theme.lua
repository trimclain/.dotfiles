...
local layouts_path = themes_path .. "layouts/light/"
...
theme.menu_submenu_icon = themes_path .. "icons/submenuw.png"
theme.menu_height = dpi(15)
theme.menu_width = dpi(100)

-- Variables set for theming the titlebar:
...
-- Variables set for theming the layouts:
...
theme.awesome_icon = themes_path .. "icons/awesomew.png"
