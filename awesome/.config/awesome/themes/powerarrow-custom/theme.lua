...
local clock = awful.widget.watch("date +'%a %d/%m/%Y %R'", 60, function(widget, stdout)
...
--     notification_preset = { font = "JetBrainsMono-Regular 11", fg = theme.fg_normal },
...
function theme.at_screen_connect(s)
    -- Quake application (Quake-like Dropdown application spawn)
