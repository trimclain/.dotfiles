...
-- theme.wallpaper = "/home/trimclain/personal/images/my-wallpapers/chrisatmachine-wallpapers/vNPlMSs.jpg"
theme.wallpaper = "~/.config/awesome/themes/powerarrow/wall.png"
